...
API_TOKEN: str = environ.get('BOT_TOKEN')  # 'AAABBBCCC:12345'
ADMIN_ID: str = environ.get('ADMIN_ID')  # [123, 456]
# BAN_LIST: list = list(map(str, environ.get('BAN_LIST').split()))    # [321, 654]
